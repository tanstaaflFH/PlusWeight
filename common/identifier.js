...
const MESSAGE_REQUEST_PROFILE_API = "REQUEST_PROFILE_FROM_WEB";
const MESSAGE_PROFILE_SUCCESS_API = "PROFILE_RETRIEVE_SUCCESS_WEB";
const MESSAGE_PROFILE_FAILURE_API = "PROFILE_RETRIEVE_FAILURE_WEB";
...
export {
    ...
    MESSAGE_REQUEST_PROFILE_API,
    MESSAGE_PROFILE_SUCCESS_API,
    MESSAGE_PROFILE_FAILURE_API,
    SETTINGS_KEY_OAUTH,
    SETTINGS_KEY_UNIT,
    REJECT,
    RESOLVE,
